...
const TestimonialsSection = () => {
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      position: "",
      rating: 5,
      text: "Das Team von Solle & Schniebel ist außergewöhnlich – fachlich brillant, strategisch scharf und zugleich menschlich absolut angenehm. Sie haben sich mit beeindruckender Gründlichkeit in meinen Fall eingearbeitet und dabei stets das große Ganze im Blick behalten. Ein echter Fels in der Brandung!",

...
const UeberUns = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/20">
      ...
      <StandardHero
        title="Über uns"
        description="Seit 2002 stehen wir für exzellente Rechtsberatung im Herzen Berlins. Erfahren Sie mehr über unsere Werte, unsere Expertise und unseren Anspruch an erstklassigen Service."
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Über uns" }
        ]}
        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="text-center max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-8 leading-tight">
              Ihre Rechtsexperten im Herzen der Hauptstadt
            </h2>
      ...
      <div className="py-20" style={{ backgroundColor: '#f8f9fa' }}>
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="text-foreground text-lg leading-relaxed space-y-6 max-w-5xl mx-auto">
            ...
            <p>
              „Exzellenz entsteht nur dort, wo Leidenschaft auf Kompetenz trifft." Diese Philosophie prägt jeden Tag unserer Arbeit bei Solle & Schniebel.
            </p>
            
            <p>
              Unser Team besteht aus überzeugten Juristen, die bewusst den Weg der spezialisierten Beratung gewählt haben. Obwohl unsere Qualifikationen auch andere Karrierewege ermöglicht hätten, haben wir uns für Solle & Schniebel entschieden - weil hier unsere Vision von erstklassiger Rechtsberatung Realität wird.
            </p>
            
            <p>
              Diese innere Überzeugung spiegelt sich in unserem unermüdlichen Einsatz für Mandanten wider, in der juristischen Präzision unserer Arbeit und in unserem Anspruch, stets die bestmöglichen Ergebnisse zu erzielen. Das sind die Werte, die Solle & Schniebel täglich zum Leben erweckt.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Solle & Schniebel verbindet traditionelle Rechtsexpertise mit modernster Technologie. Unsere digitale Kanzleiführung ermöglicht es uns, effizienter zu arbeiten und bessere Ergebnisse für unsere Mandanten zu erzielen.
            </p>
            <br />
            <p className="text-xl text-white/90 leading-relaxed">
        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-12 text-center leading-tight">
              Was Solle & Schniebel einzigartig macht
            </h2>

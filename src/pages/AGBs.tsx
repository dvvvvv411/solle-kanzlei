        ...
        <div className="space-y-6">
          <section className="space-y-4">
            ...
            <div className="text-muted-foreground leading-relaxed space-y-2">
              <p>Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für alle Rechts- und Steuerberatungsleistungen der Kanzlei Solle & Schniebel. Sie werden Bestandteil aller Verträge über die Erbringung anwaltlicher und steuerberatender Leistungen.</p>
